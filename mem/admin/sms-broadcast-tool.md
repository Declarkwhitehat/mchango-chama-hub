...
Segments supported: `all_users`, `kyc_approved`, `kyc_missing`, `chama_creators`, `chama_members`, `welfare_creators`, `welfare_members`, `mchango_creators`, `mchango_donors`, `top_trust` (trust_score ≥ 80). Phones normalized to `254XXXXXXXXX`, deduplicated, sent via Onfon `SendBulkSMS` in concurrent batches of 10.
