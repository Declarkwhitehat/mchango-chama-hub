...
type EntityTable = "chama" | "welfares" | "organizations" | "mchango";
...
interface WhatsAppLinkManagerProps {
  ...
  isManager: boolean;
  entityLabel?: string; // e.g., "chama", "welfare", "organization", "campaign"
  onUpdate?: () => void;
}
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          {isManager
            ? `Share your ${entityLabel}'s WhatsApp group link with members`
            : `Join the ${entityLabel}'s WhatsApp group for updates`}
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isEditing ? (
          ...
          <div className="space-y-3">
            {currentLink ? (
              <a
                ...
                className="flex items-center gap-2 p-3 bg-green-500/10 border border-green-500/20 rounded-lg text-green-700 dark:text-green-400 hover:bg-green-500/20 transition-colors"
              >
