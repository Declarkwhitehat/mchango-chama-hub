...
const AdminChamaSimulator = lazy(() => import("./pages/AdminChamaSimulator"));
      ...
      <MaintenanceGate>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/admin/chama-simulator" element={<AdminProtectedRoute><AdminChamaSimulator /></AdminProtectedRoute>} />
