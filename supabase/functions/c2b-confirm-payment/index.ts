...
async function handleCallback(callbackData: any): Promise<Response> {
  try {
    ...
    if (chamaMemberData) {
      ...
      // NOTE: payouts are NOT triggered by payments any more. Every chama
      // cycle is paid out by daily-payout-cron at 21:00 EAT on the cycle's
      // payout day, whether or not all members have paid.
